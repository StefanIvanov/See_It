...
- (void)viewDidLoad
{
    ...
    self.view.layer.shadowRadius = 3.8f;
    ...
    NSError *error3 = nil;
 	...
 	NSDictionary * dict = [NSJSONSerialization JSONObjectWithData:jsonData options:NSJSONReadingMutableContainers error:&error3];
 	if (dict)
 	{
