...
- (void)viewDidLoad
{
    ...
    for (int i = 0;  i < rows.count; i++)
    {
        ...
        CLRegion *region = [[CLRegion alloc] initCircularRegionWithCenter:location radius:4 identifier:[rows[i] objectForKey:@"placeName"]]; //regionRadius instead of fixed value
...
-(MKAnnotationView *)mapView:(MKMapView *)mapView viewForAnnotation:(id<MKAnnotation>)annotation
{
    ...
    //Pin image
    pinView.image=[UIImage imageNamed:@"pin7beta5.png"]; 
    pinView.frame= CGRectMake(5, 0, 26, 36);
...
calloutAccessoryControlTapped:(UIControl *)control {
    ...
    [infoCon loadInfoForKey:((SIAnnotation *)view.annotation).title];
